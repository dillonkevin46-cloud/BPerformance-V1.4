...
from core.views import (
    ...
    htmx_staff_tickets, # Make sure this is imported
    report_archive_view, mark_report_submitted, generate_pdf_view,
    staff_index_view, staff_detail_view, send_weekly_report_view, export_staff_pdf_view,
    delete_setting_item, delete_staff_note, delete_staff_warning,
    
    # SCHEDULER VIEWS
    scheduler_dashboard_view, htmx_add_schedule_slot, htmx_move_schedule_slot, 
    htmx_delete_schedule_slot, scheduler_approval_landing, scheduler_finalize_approval, 
    scheduler_history_view,
